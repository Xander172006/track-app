        ...
        <footer className='w-full mt-auto bg-black'>
            ...
            <div className='bg-gray-900 w-full grid grid-cols-1 sm:grid-cols-2 gap-5 text-gray-400 p-6 place-items-center'>
                <div className='flex flex-col gap-4'>
                    ...
                    <span className='flex flex-row items-center gap-1 text-[0.85rem] mt-6'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt-fill" viewBox="0 0 16 16">
