    ...
    return (
        <div className='flex flex-col gap-[2rem]'>
            <div className='flex flex-row items-center gap-4'>
                <img src="https://cdn.accounts.nintendo.com/account/images/common/defaults/mii.png?t=1693897123" alt="profilePicture" className='w-[20%] rounded-[20px]'/>
                <h1 className='text-[1.3rem]'>{user.name}</h1>
            </div>
            ...
            <div>
                <div className='flex flex-col gap-5'>
                    ...
                    <button onClick={() => setActiveTab("beveiliging")} className={`flex flex-row items-center gap-3 ${activeTab === "beveiliging" ? "text-orange-500" : "text-white"}`}>
                        <span>
                        ...
                        <span className='transition hover:translate-x-2 duration-300 ease-in-out'>Inlog- en beveiligingsinstellingen</span>
                    </button>
